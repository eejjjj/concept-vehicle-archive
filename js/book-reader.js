 ...
 */
const PAPER_TINT = new THREE.Color(0xeae8e2);
const INK_FLOOR = new THREE.Color(0x2a2927);
const PAPER_GRAIN = 0.032;

function patchPaperMaterial(mat) {
  mat.toneMapped = false;
  mat.customProgramCacheKey = () => 'emax-paper-print-v2';
